...
namespace TheForestWaiter.Game.Objects
{
	...
	class Gib : Movable
	{
		...
		{
			Sheet = sheet;
			Size = Sheet.Rect.CellSize.ToVector2f();
		...
		public override void Update(float time)
		{
			...
			{
				var c = (float)(Math.Min(Sheet.Rect.CellSize.X, Sheet.Rect.CellSize.Y) * Math.PI);
		...
		public override void Draw(RenderWindow window)
		{
			...
			Sheet.Sprite.Origin = (Sheet.Rect.CellSize / 2).ToVector2f();
