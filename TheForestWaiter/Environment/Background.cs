...
namespace TheForestWaiter.Environment
{
	class Background
	{
		...
		{
			_spriteSky = GameContent.Textures.CreateSprite("Textures\\Background\\sky.png");
			_spriteStars = GameContent.Textures.CreateSprite("Textures\\Background\\stars.png");
			_spriteMountain = GameContent.Textures.CreateSprite("Textures\\Background\\mountains.png");
			_spriteTrees = GameContent.Textures.CreateSprite("Textures\\Background\\trees.png");
